...
// you need to make sure the base element class has been read in first!
...
class formulizeDummyElementHandler extends formulizeElementsHandler {
	...
	function prepareDataForSaving($value, $element) {
		return icms::$xoopsDB->escape($value); // strictly speaking, formulize will already escape all values it writes to the database, but it's always a good habit to never trust what the user is sending you!
	}
