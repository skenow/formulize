...
class formulizeListOfEntriesScreenHandler extends formulizeScreenHandler {
	...
	function editForm($screen, $fid) {
		...
		$usecurrentviewlist = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_CURRENTVIEWLIST, 'usecurrentviewlist', 20, 255, $usecurrentviewlistDefault);
		...
		$entriesperpage = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_ENTRIESPERPAGE, 'entriesperpage', 4, 4, $entriesperpageDefault);
		...
		$repeatheaders = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_REPEATHEADERS, 'repeatheaders', 2, 2, $repeatheadersDefault);
		...
		$columnwidth = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_COLUMNWIDTH, 'columnwidth', 3, 3, $columnwidthDefault);
		...
		$textwidth = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_TEXTWIDTH, 'textwidth', 3, 3, $textwidthDefault);
		...
		$desavetext = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_DESAVETEXT, 'desavetext', 20, 255, $desavetextDefault);
		...
		$useaddupdate = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_ADDENTRY . "/" . _formulize_DE_UPDATEENTRY . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useaddupdate', 20, 255, $useaddupdateDefault);
		...
		$useaddmultiple = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_ADD_MULTIPLE_ENTRY . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useaddmultiple', 20, 255, $useaddmultipleDefault);
		...
		$useaddproxy = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_PROXYENTRY . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useaddproxy', 20, 255, $useaddproxyDefault);
		...
		$useexport = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_EXPORT . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useexport', 20, 255, $useexportDefault);
		...
		$useimport = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_IMPORT . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useimport', 20, 255, $useimportDefault);
		...
		$usenotifications = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_NOTBUTTON . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'usenotifications', 20, 255, $usenotificationsDefault);
		...
		$usechangecols = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_CHANGECOLS . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'usechangecols', 20, 255, $usechangecolsDefault);
		...
		$usecalcs = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_CALCS . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'usecalcs', 20, 255, $usecalcsDefault);
		...
		$useadvcalcs = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_CALCS . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useadvcalcs', 20, 255, $useadvcalcsDefault);
		...
		$useexportcalcs = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_EXPORT_CALCS . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useexportcalcs', 20, 255, $useexportcalcsDefault);
		...
		$useadvsearch = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_ADVSEARCH . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useadvsearch', 20, 255, $useadvsearchDefault);
		...
		$useclone = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_CLONESEL . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useclone', 20, 255, $usecloneDefault);
		...
		$usedelete = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_DELETESEL . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'usedelete', 20, 255, $usedeleteDefault);
		...
		$useselectall = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_SELALL . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useselectall', 20, 255, $useselectallDefault);
		...
		$useclearall = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_CLEARALL . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'useclearall', 20, 255, $useclearallDefault);
		...
		$usereset = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_RESETVIEW . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'usereset', 20, 255, $useresetDefault);
		...
		$usesave = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_SAVE . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'usesave', 20, 255, $usesaveDefault);
		...
		$usedeleteview = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_BUTTON1 . _formulize_DE_DELETE . _AM_FORMULIZE_SCREEN_LOE_BUTTON2, 'usedeleteview', 20, 255, $usedeleteviewDefault);
		...
		if (isset($_POST['addCustomButton'])) {
			if ($customButtonUI != "") {
				$caid++ ;
			} // increment the caid, if there are already buttons
...
function addCustomButton($caid, $thisCustomAction, $allFids, $allFidObjs, $elementOptions, $fid) {
	...
	$caHandle = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_CUSTOMBUTTON_HANDLE, 'handle_' . $caid, 20, 255, $handleDefault);
	$caTable = addElementLOE($caHandle, $caTable);
	$caText = new icms_form_elements_Text(_AM_FORMULIZE_SCREEN_LOE_CUSTOMBUTTON_BUTTONTEXT, 'buttontext_' . $caid, 20, 255, $textDefault);
	...
	$applyToOptions = array('inline' => _AM_FORMULIZE_SCREEN_LOE_CUSTOMBUTTON_APPLYTO_INLINE,
		...
		'all' => _AM_FORMULIZE_SCREEN_LOE_CUSTOMBUTTON_APPLYTO_ALL,
		'new' => _AM_FORMULIZE_SCREEN_LOE_CUSTOMBUTTON_APPLYTO_NEW,
		'new_per_selected' => _AM_FORMULIZE_SCREEN_LOE_CUSTOMBUTTON_APPLYTO_NEWPERSELECTED);
	if (count($allFids) > 1) {
		foreach ($allFids as $i => $thisFid) {
			if ($thisFid == $fid) {
				continue;
			} // don't treat the current form as if it's an 'other' form
	...
	foreach ($thisCustomAction as $effectid => $effectProperties) {
		if (!is_numeric($effectid)) {
			continue;
		} // ignore the handle, messagetext, etc.
