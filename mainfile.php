...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/Applications/XAMPP/xamppfiles/htdocs/formulize_git' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_ROOT_PATH', '/Applications/XAMPP/xamppfiles/htdocs/formulize_git' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/Applications/XAMPP/xamppfiles/238111716759907' );
	define( 'XOOPS_TRUST_PATH', '/Applications/XAMPP/xamppfiles/238111716759907' );

	include_once XOOPS_TRUST_PATH . '/c2b900faa7c4adb1509f166294caf40b.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://localhost/formulize_git' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_URL', 'http://localhost/formulize_git' );
	// AS DETERMINED FROM FIRST PRINCIPLES:
